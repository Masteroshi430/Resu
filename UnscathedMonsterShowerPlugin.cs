...
// Unscathed Monster Shower plugin for TurboHUD version 10/10/2018 10:26
...
namespace Turbo.Plugins.Resu
{
    ...
    public class UnscathedMonsterShowerPlugin : BasePlugin, IInGameWorldPainter
    {
        ...
        public void PaintWorld(WorldLayer layer)
        {
         ...
         {
          UnscathedMonsterDecorator.Paint(layer, UnscathedMonster, UnscathedMonster.FloorCoordinate.Offset(0, 0, (UnscathedMonster.RadiusScaled*3)), "\u2B2C \u2B2C"); // round \u2022 eye \uD83D\uDC41
         }
